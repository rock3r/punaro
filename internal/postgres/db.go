...
WITH objects AS (
	...
	SELECT expected.* FROM objects, LATERAL (VALUES
		...
		(rotate_oid, CASE WHEN $1 < 34 THEN 'bacc5a1a2184a80240f570b8624535ea' ELSE 'b7d9e8e1931e232234154cd906bb46ad' END, 'plpgsql', 'v'::"char", false, 'TABLE(installation_id uuid, timeline_id uuid, change_sequence bigint)')
