    ...
    AND EXISTS (
        ...
        WHERE conrelid = 'audit.events'::regclass AND conname = 'events_action_check'
          ...
          AND (($1 = 3 AND pg_get_expr(conbin, conrelid) = '(action = ANY (ARRAY[''principal.create''::text, ''project.create''::text, ''grant.create''::text, ''grant.delete''::text, ''job.enqueue''::text, ''job.complete''::text, ''job.retry''::text, ''job.fail''::text, ''owner.bootstrap''::text, ''enrollment.create''::text, ''enrollment.redeem''::text, ''credential.rotate''::text, ''credential.revoke''::text, ''legacy.register''::text, ''legacy.exchange''::text, ''legacy.retire''::text, ''legacy.disable''::text]))')
            ...
            OR ($1 = 15 AND pg_get_expr(conbin, conrelid) = '(action = ANY (ARRAY[''principal.create''::text, ''project.create''::text, ''grant.create''::text, ''grant.delete''::text, ''job.enqueue''::text, ''job.complete''::text, ''job.retry''::text, ''job.fail''::text, ''owner.bootstrap''::text, ''enrollment.create''::text, ''enrollment.redeem''::text, ''credential.rotate''::text, ''credential.revoke''::text, ''legacy.register''::text, ''legacy.exchange''::text, ''legacy.retire''::text, ''legacy.disable''::text, ''project.identity.attach''::text, ''project.merge.preview''::text, ''project.merge''::text, ''memory.create''::text, ''memory.update''::text, ''memory.archive''::text, ''memory.restore''::text, ''memory.delete''::text, ''memory.secret_exception.create''::text, ''memory.secret_exception.revoke''::text]))')
            OR ($1 = 16 AND pg_get_expr(conbin, conrelid) = '(action = ANY (ARRAY[''principal.create''::text, ''project.create''::text, ''grant.create''::text, ''grant.delete''::text, ''job.enqueue''::text, ''job.complete''::text, ''job.retry''::text, ''job.fail''::text, ''owner.bootstrap''::text, ''enrollment.create''::text, ''enrollment.redeem''::text, ''credential.rotate''::text, ''credential.revoke''::text, ''legacy.register''::text, ''legacy.exchange''::text, ''legacy.retire''::text, ''legacy.disable''::text, ''project.identity.attach''::text, ''project.merge.preview''::text, ''project.merge''::text, ''memory.create''::text, ''memory.update''::text, ''memory.archive''::text, ''memory.restore''::text, ''memory.delete''::text, ''memory.secret_exception.create''::text, ''memory.secret_exception.revoke''::text, ''memory.secret_rescan''::text, ''memory.quarantine''::text, ''memory.quarantine_release''::text]))')
            OR ($1 = 17 AND pg_get_expr(conbin, conrelid) = '(action = ANY (ARRAY[''principal.create''::text, ''project.create''::text, ''grant.create''::text, ''grant.delete''::text, ''job.enqueue''::text, ''job.complete''::text, ''job.retry''::text, ''job.fail''::text, ''owner.bootstrap''::text, ''enrollment.create''::text, ''enrollment.redeem''::text, ''credential.rotate''::text, ''credential.revoke''::text, ''legacy.register''::text, ''legacy.exchange''::text, ''legacy.retire''::text, ''legacy.disable''::text, ''project.identity.attach''::text, ''project.merge.preview''::text, ''project.merge''::text, ''memory.create''::text, ''memory.evidence_create''::text, ''memory.update''::text, ''memory.archive''::text, ''memory.restore''::text, ''memory.delete''::text, ''memory.secret_exception.create''::text, ''memory.secret_exception.revoke''::text, ''memory.secret_rescan''::text, ''memory.quarantine''::text, ''memory.quarantine_release''::text]))')
            OR ($1 BETWEEN 18 AND 21 AND pg_get_expr(conbin, conrelid) = '(action = ANY (ARRAY[''principal.create''::text, ''project.create''::text, ''grant.create''::text, ''grant.delete''::text, ''job.enqueue''::text, ''job.complete''::text, ''job.retry''::text, ''job.fail''::text, ''owner.bootstrap''::text, ''enrollment.create''::text, ''enrollment.redeem''::text, ''credential.rotate''::text, ''credential.revoke''::text, ''legacy.register''::text, ''legacy.exchange''::text, ''legacy.retire''::text, ''legacy.disable''::text, ''project.identity.attach''::text, ''project.merge.preview''::text, ''project.merge''::text, ''memory.create''::text, ''memory.evidence_create''::text, ''memory.update''::text, ''memory.archive''::text, ''memory.restore''::text, ''memory.delete''::text, ''memory.secret_exception.create''::text, ''memory.secret_exception.revoke''::text, ''memory.secret_rescan''::text, ''memory.quarantine''::text, ''memory.quarantine_release''::text, ''memory.proposal.create''::text, ''memory.proposal.approve''::text, ''memory.proposal.reject''::text, ''memory.proposal.expire''::text, ''memory.proposal.prune''::text]))')
            OR ($1 >= 22 AND pg_get_expr(conbin, conrelid) = '(action = ANY (ARRAY[''principal.create''::text, ''project.create''::text, ''grant.create''::text, ''grant.delete''::text, ''job.enqueue''::text, ''job.complete''::text, ''job.retry''::text, ''job.fail''::text, ''owner.bootstrap''::text, ''enrollment.create''::text, ''enrollment.redeem''::text, ''credential.rotate''::text, ''credential.revoke''::text, ''legacy.register''::text, ''legacy.exchange''::text, ''legacy.retire''::text, ''legacy.disable''::text, ''project.identity.attach''::text, ''project.merge.preview''::text, ''project.merge''::text, ''memory.create''::text, ''memory.evidence_create''::text, ''memory.update''::text, ''memory.archive''::text, ''memory.restore''::text, ''memory.delete''::text, ''memory.secret_exception.create''::text, ''memory.secret_exception.revoke''::text, ''memory.secret_rescan''::text, ''memory.quarantine''::text, ''memory.quarantine_release''::text, ''memory.proposal.create''::text, ''memory.proposal.approve''::text, ''memory.proposal.reject''::text, ''memory.proposal.expire''::text, ''memory.proposal.prune''::text, ''memory.reconcile''::text]))'))
    )
    AND EXISTS (
        SELECT 1 FROM pg_constraint
        WHERE conrelid = 'audit.events'::regclass AND conname = 'events_target_kind_check'
          ...
          AND (($1 = 3 AND pg_get_expr(conbin, conrelid) = '(target_kind = ANY (ARRAY[''principal''::text, ''project''::text, ''grant''::text, ''job''::text, ''enrollment''::text, ''credential''::text, ''legacy_machine''::text]))')
            ...
            OR ($1 BETWEEN 14 AND 17 AND pg_get_expr(conbin, conrelid) = '(target_kind = ANY (ARRAY[''principal''::text, ''project''::text, ''grant''::text, ''job''::text, ''enrollment''::text, ''credential''::text, ''legacy_machine''::text, ''project_identity''::text, ''project_merge''::text, ''memory_item''::text]))')
            OR ($1 >= 18 AND pg_get_expr(conbin, conrelid) = '(target_kind = ANY (ARRAY[''principal''::text, ''project''::text, ''grant''::text, ''job''::text, ''enrollment''::text, ''credential''::text, ''legacy_machine''::text, ''project_identity''::text, ''project_merge''::text, ''memory_item''::text, ''memory_proposal''::text]))'))
    )
...
FROM objects, table_ownership, routine_safety, routine_acl, table_acl, schema_acl, column_safety`, snapshot.Records[len(snapshot.Records)-1].Version).Scan(&backupObjectsPresent); err != nil {
	...
	if snapshot.CurrentObjectsPresent && len(snapshot.Records) > 0 && snapshot.Records[len(snapshot.Records)-1].Version >= 15 {
		guardObjectsPresent, err := secretGuardControlsAvailable(ctx, q)
		if err != nil {
			return Snapshot{}, errors.New("PostgreSQL secret guard schema cannot be inspected")
		}
		snapshot.CurrentObjectsPresent = guardObjectsPresent
	}
	if snapshot.CurrentObjectsPresent && len(snapshot.Records) > 0 && snapshot.Records[len(snapshot.Records)-1].Version >= 16 {
		quarantineObjectsPresent, err := memoryQuarantineControlsAvailable(ctx, q)
		if err != nil {
			return Snapshot{}, errors.New("PostgreSQL memory quarantine schema cannot be inspected")
		}
	...
	if snapshot.CurrentObjectsPresent && len(snapshot.Records) > 0 && snapshot.Records[len(snapshot.Records)-1].Version >= 17 {
		...
		snapshot.CurrentObjectsPresent = evidenceObjectsPresent
	}
	if snapshot.CurrentObjectsPresent && len(snapshot.Records) > 0 && snapshot.Records[len(snapshot.Records)-1].Version >= 18 {
		proposalObjectsPresent, err := memoryProposalControlsAvailable(ctx, q)
		if err != nil {
	...
	if snapshot.CurrentObjectsPresent && len(snapshot.Records) > 0 && snapshot.Records[len(snapshot.Records)-1].Version >= 22 {
		reconciliationObjectsPresent, err := memoryReconciliationControlsAvailable(ctx, q)
		if err != nil {
			return Snapshot{}, errors.New("PostgreSQL memory reconciliation schema cannot be inspected")
		}
	...
	if snapshot.CurrentObjectsPresent && len(snapshot.Records) > 0 && snapshot.Records[len(snapshot.Records)-1].Version >= 33 {
		consolidationObjectsPresent, err := memoryConsolidationControlsAvailable(ctx, q, snapshot.Records[len(snapshot.Records)-1].Version)
		if err != nil {
	...
	if snapshot.CurrentObjectsPresent && len(snapshot.Records) > 0 && snapshot.Records[len(snapshot.Records)-1].Version >= 41 {
		controlObjectsPresent, err := relayMembershipControlsAvailable(ctx, q, snapshot.Records[len(snapshot.Records)-1].Version)
		if err != nil {
	...
	if snapshot.CurrentObjectsPresent && len(snapshot.Records) > 0 && snapshot.Records[len(snapshot.Records)-1].Version >= 58 {
		fleetObjectsPresent, err := fleetControlsAvailable(ctx, q)
		if err != nil {
			return Snapshot{}, errors.New("PostgreSQL fleet-config schema cannot be inspected")
		}
