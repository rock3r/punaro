...
- The source rejects every non-literal-loopback listener and both attachment
  switches fail closed before a listener is constructed.
- `punarod` has no attachment-operation route mount or WebRTC constructor.
