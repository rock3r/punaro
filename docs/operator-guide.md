...
mail rate-limit buckets, and migration 47 adds idempotent direct-role
conversations. Migration 44 invalidates unredeemed legacy enrollment invitations while
